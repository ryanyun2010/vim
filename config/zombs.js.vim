...
var distancey=0.2;
var isLeader = false;
var socket, gameWorld, panda, bushes, resources, crates;
var images = {

	tile: { url: tile, image: new Image() },
	bamboogun: { url: 'https://ryan1.wisen.space/capture/load/fyrsaulbqnc99c_dssov7rhl.png', image: new Image() },
	bamboo: {url:'http://www.pngmart.com/files/5/Bamboo-Stick-PNG-Pic-279x279.png', image: new Image()},
	bush: { url: 'https://mrlera.wisen.space/capture/load/kjFJM9XwclT7aYeLa_ka2p8R.png', image: new Image() }
